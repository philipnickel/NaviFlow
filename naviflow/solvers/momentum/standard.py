...
def solve_momentum(imax, jmax, dx, dy, rho, mu, u, v, p, velocity, alpha):
    """
    Solve momentum equations for u and v components.
    
    This function is meant to be used with the u-momentum solver only.
    The v-momentum solver is called separately in the SIMPLE algorithm.
    ...
    d_u : ndarray
        u-velocity correction coefficient
    """
    # Only solve u-momentum equation
