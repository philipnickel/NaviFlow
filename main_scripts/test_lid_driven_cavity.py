"""
Lid-driven cavity flow simulation using the collocated framework with JIT-compiled matrix assembly.
"""
...
from naviflow_collocated.preprocessing.mesh.structured import StructuredMesh
from naviflow_collocated.constructor.properties.fluid import FluidProperties
from naviflow_collocated.assembly.convection_diffusion_matrix import assemble_diffusion_convection_matrix
from naviflow_collocated.solver.Algorithms.simple import SimpleSolver
from naviflow_collocated.solver.pressure_solver.direct import DirectPressureSolver
from naviflow_collocated.solver.momentum_solver.jacobi_solver import JacobiMomentumSolver
from naviflow_collocated.solver.velocity_solver.standard import StandardVelocityUpdater
...
# 7. Solve the problem
print("Starting simulation with JIT-compiled matrix assembly...")
...
result.plot_combined_results(
    title=f'JIT-Compiled Cavity Flow Results (Re={reynolds})',
    filename=os.path.join(results_dir, f'cavity_Re{reynolds}_jit_results.pdf'),
    show=True
) 