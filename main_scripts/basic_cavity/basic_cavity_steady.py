...
from naviflow.utils.plotting import plot_velocity_field, plot_streamlines, create_animation
from naviflow.utils.validation import compare_with_ghia, calculate_divergence
...
plt.savefig(f'cavity_ux_Re{Re:.0f}.png')
plt.show()
...
plt.legend()
plt.savefig(f'v_centerline_comparison_Re{Re:.0f}.png')
plt.show()
...
np.savetxt('ghia_comparison_Re100.txt', comparison_data, 
           header='x Ghia_v Simulation_v Abs_Error', delimiter='\t')

# After your simulation is complete:
