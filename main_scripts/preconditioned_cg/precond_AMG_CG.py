...
alpha_p = 0.1            # Even more conservative pressur relaxation
...
pressure_solver = PreconditionedCGSolver(
    tolerance=1e-6,        # Even tighter tolerance for pressure solver
    max_iterations=30000,   # More iterations allowed
