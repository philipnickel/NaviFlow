...
def get_rhs(mesh, rho, u_star, v_star, p, d_avg, bc_manager=None):
    ...
    Includes correction for pressure pinning.
    """
    ...
    for face_idx in range(n_faces):
        ...
        if neighbor >= 0 and neighbor < n_cells:
            ...
            # Boundary face - No contribution in core function (handled externally)
            pass

    # --- Apply pressure pinning correction ---
    if n_cells > 0:
        rhs[0] = 0.0  # Set RHS at pinned pressure cell to zero
