...
u, v, p = simple_algorithm(mesh, alpha_uv, alpha_p, reynolds_number, max_iter, tolerance, scheme, limiter)
...
# U velocity
cf1 = axs[0, 0].tricontourf(x, y, u, levels=50, cmap="coolwarm")
fig.colorbar(cf1, ax=axs[0, 0])
axs[0, 0].set_title("U Velocity")

# V velocity
cf2 = axs[0, 1].tricontourf(x, y, v, levels=50, cmap="coolwarm")
