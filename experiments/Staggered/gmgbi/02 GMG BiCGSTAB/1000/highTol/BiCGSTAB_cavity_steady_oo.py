...
momentum_solver = AMGMomentumSolver(tolerance=1e-10, max_iterations=10000)
#momentum_solver = MatrixMomentumSolver(tolerance=1e-6, max_iterations=10000)
#momentum_solver = MatrixFreeMomentumSolver(tolerance=1e-9, max_iterations=10000, solver_type='bicgstab')
