...
Re=5000, 127x127 structured mesh with Power Law discretization
"""
...
alpha_p = 0.03             # Extremely conservative pressure relaxation
alpha_u = 0.15             # Extremely conservative velocity relaxation
...
pressure_tolerance = 1e-15  # Extremely strict pressure tolerance
...
momentum_solver = MatrixFreeMomentumSolver(tolerance=1e-15, max_iterations=30000, solver_type='bicgstab')
...
metadata = {
    ...
    'Momentum solver tolerance': '1e-15',
