...
Re=1000, 127x127 structured mesh with Power Law discretization
"""
...
alpha_p = 0.1              # Very conservative pressure relaxation
alpha_u = 0.3              # Very conservative velocity relaxation
...
pressure_solver = MatrixFreeBiCGSTABSolver(
    ...
    smoother_relaxation=0.8,
    smoother_method_type='red_black'
)
momentum_solver = MatrixFreeMomentumSolver(tolerance=1e-12, max_iterations=20000, solver_type='bicgstab')
