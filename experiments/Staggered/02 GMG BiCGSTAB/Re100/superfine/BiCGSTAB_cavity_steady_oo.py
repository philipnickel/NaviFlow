...
Re=100, 255x255 structured mesh with Power Law discretization
"""
...
tolerance = 1e-8           # Stricter tolerance for convergence
h = 1/nx 
disc_order = 1
expected_disc_error = h**(disc_order)
#pressure_tolerance = expected_disc_error 
pressure_tolerance = 1e-12  # Much stricter pressure tolerance
...
metadata = {
    ...
    'Multigrid pre-smoothing steps': 2,
    'Multigrid post-smoothing steps': 2,
    'Multigrid smoother relaxation': 1.2,
